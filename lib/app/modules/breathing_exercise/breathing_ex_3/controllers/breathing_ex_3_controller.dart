...
class BreathingEx3Controller extends GetxController {
  ...
  var lyricModel =
      LyricsModelBuilder.create().bindLyricToMain(breathingEx3Lyric).getModel();
  ...
  onPlay() {
    if (audioPlayer == null) {
      audioPlayer = AudioPlayer()..play(AssetSource('breathing_ex_3.mp3'));
      playing.value = true;
