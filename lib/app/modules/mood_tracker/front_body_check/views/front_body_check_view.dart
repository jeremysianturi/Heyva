...
class FrontBodyCheckView extends GetView<FrontBodyCheckController> {
  const FrontBodyCheckView({Key? key}) : super(key: key);
...
class MoodCheckForm1 extends StatelessWidget {
  ...
  final FrontBodyCheckController controller;
